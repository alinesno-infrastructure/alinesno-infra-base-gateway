...
public class BalancedRest extends BaseRest<Balanced> {
    ...
    public ApiResult add(@RequestBody BalancedReq balancedReq) {
        ...
        Balanced balanced = getBalanced(balancedReq);
        this.toExampleOrg(balanced, balancedReq.getOrgId());
    ...
    @NotNull
    private static Balanced getBalanced(BalancedReq balancedReq) {
        Balanced balanced = new Balanced();

        balanced.setOperatorId(balancedReq.getOperatorId());
        balanced.setOrgId(balancedReq.getOrgId());
