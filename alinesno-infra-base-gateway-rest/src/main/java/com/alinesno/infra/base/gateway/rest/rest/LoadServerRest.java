...
import com.alinesno.infra.base.gateway.facade.bean.LoadServerReq;
...
public class LoadServerRest extends BaseRest<LoadServer> {
    ...
    private ApiResult list(LoadServerReq loadServerReq, boolean isReg){
        ...
        if (isReg) {
            ...
            return new ApiResult(loadServerService.notLoadServerPageList(currentPage, pageSize, String.valueOf(loadServerReq.getOperatorId())));
        }
    }
