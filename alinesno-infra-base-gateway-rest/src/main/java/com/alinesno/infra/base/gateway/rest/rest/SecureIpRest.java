...
import com.alinesno.infra.base.gateway.facade.bean.SecureIpReq;
import com.alinesno.infra.base.gateway.facade.dto.ApiResult;
import com.alinesno.infra.base.gateway.facade.entity.Account;
import com.alinesno.infra.base.gateway.facade.entity.SecureIp;
...
public class SecureIpRest extends BaseRest<SecureIp> {
    ...
    public ApiResult delete(@RequestParam String ip) {
        ...
        // 获取当前用户
       long operatorId = CurrentAccountJwt.getUserId();
    ...
    public ApiResult pageList(@RequestBody SecureIpReq secureIpReq){
        ...
        this.toExampleOrg(secureIp, secureIpReq.getOrgId());
